defmodule PostDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PostDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PostDemoWeb.Gettext, "errors", msg, opts)
    end
  end
